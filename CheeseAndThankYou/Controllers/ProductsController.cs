...
namespace CheeseAndThankYou.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,StinkRating,Description,Price,Image,Size,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,StinkRating,Description,Price,Image,Size,CategoryId")] Product product)
        {
